...
import DonationCard from '@/components/others/DonationCard';
import ShareClassButtons from '@/components/students/classes/ShareClassButtons';
            ...
            <section className="rounded-lg border border-white/10 bg-gray-900 p-6 shadow-lg">
              ...
              <div className="mt-4 space-y-3 border-l border-white/10 pl-6">
                ...
                <p className="text-base">
                  ...
                  {classItem.cp_contact ? (
                    <a 
                      href={`https://wa.me/${classItem.cp_contact.replace(/\D/g, '')}`} 
                      target="_blank"
                      rel="noreferrer"
              ...
              {classItem.whatsapp_link && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-6 inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-500 px-5 py-3 text-sm font-bold text-slate-950 transition hover:bg-emerald-300"
                >
