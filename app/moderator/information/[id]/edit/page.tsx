...
export default function EditFAQPage() {
    ...
    const fetchFAQ = async () => {
      try {
        ...
        if (!data) {
          ...
          router.push('/moderator/information');
          return;
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(message || 'Failed to update FAQ', 'error');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#535350] p-4 md:p-8 text-white flex items-center justify-center">
    ...
    <div className="min-h-screen bg-[#535350] p-4 md:p-8 text-white">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold uppercase tracking-wider">Edit FAQ</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 rounded-2xl p-8 border border-gray-800 space-y-6 shadow-xl">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="Enter keywords separated by commas (e.g., registration, deadline, enrollment)"
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500 transition-colors"
            />
