          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            <div className="flex items-center -space-x-6">
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-[#846363] overflow-hidden bg-gray-800 shadow-2xl">
                <Image src="/images/dev1.png" alt="Developer" width={128} height={128} className="object-cover" />
              </div>
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-[#846363] overflow-hidden bg-gray-700 shadow-2xl">
                <Image src="/images/dev2.png" alt="Developer" width={128} height={128} className="object-cover" />
              </div>
            </div>

            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight uppercase">Support us</h2>
