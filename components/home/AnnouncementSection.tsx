...
import ChatModal, { ResponseWithProfile } from '../others/ChatModal';
          ...
          return (
            <div key={ann.id} className={`relative border-l-4 border-green-500 pl-4 py-6 flex flex-col rounded-r-xl ${cardColor} h-full`}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-white font-bold tracking-wide text-lg">{ann.username || 'Announcement'}</h2>
              </div>
                ...
                <div className="flex flex-wrap items-center gap-3 mt-auto">
                  {currentUserId === ann.ownerId ? (
                    <>
                      ...
                      <Link href="/announcements/manage" className="text-blue-400 hover:text-blue-300 text-xs font-bold flex items-center gap-1">
                        OPEN
      ...
      <div key={currentIndex} className="animate-in slide-in-from-bottom-5 fade-in duration-300 relative z-10">
        ...
        {message ? (
          ...
          <div className="flex flex-col items-start gap-3">
            <p className="text-gray-300 text-base font-semibold"> Ask students, announce or advertise</p>
            <Link href="/announcements/manage" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-md transition-colors text-sm tracking-wider">
              Announce
            </Link>
          </div>
        )}
